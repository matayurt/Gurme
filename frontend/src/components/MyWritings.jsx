...
// COMPONENTS
import FeaturedWritings from './FeaturedWritings.jsx';
import AllWritings from './AllWritings.jsx';
...
const MyWritings = () => {
  ...
  const writingsSliders = sliders.filter((slider) => slider.page === 'yazilarim');
          ...
          <div className="relative mt-0 overflow-hidden">
            {loading ? (
              ...
              <Slider {...sliderSettings}>
                {writingsSliders.flatMap((slider) => slider.images).map((img, index) => (
                  <div key={index} className="relative flex justify-center items-center">
                    ...
                    <div className="absolute top-0 left-0 w-full text-center text-white py-2">
                      ...
                      {' > '}
                      <Link to="/yazilarim" className="hover:underline">
                        Yazılarım
                      </Link>
                    </div>
